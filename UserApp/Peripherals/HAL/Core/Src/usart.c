...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PA12     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = MS5837_RX_Pin|MS5837_TX_Pin;
  ...
  */
    ...
    PE8     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = INS_TX_Pin|INS_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PB11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = TTL232_TX_Pin|TTL232_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA12     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOA, MS5837_RX_Pin|MS5837_TX_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, INS_TX_Pin|INS_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, TTL232_TX_Pin|TTL232_RX_Pin);
