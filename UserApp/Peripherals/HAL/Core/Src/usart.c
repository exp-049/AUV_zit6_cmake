...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PA12     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = MS5837_RXA11_Pin|MS5837_TXA12_Pin;
  ...
  */
    ...
    PE8     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = MS5837_TX_Pin|MS5837_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PB15     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = INS_RX_Pin|INS_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  ...
  */
    ...
    PA3     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = AGX_TX_Pin|AGX_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PB11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = USBL_TX_Pin|USBL_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PC7     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = VIT6_TX_Pin|VIT6_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA12     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOA, MS5837_RXA11_Pin|MS5837_TXA12_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, MS5837_TX_Pin|MS5837_RX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB15     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, INS_RX_Pin|INS_TX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, AGX_TX_Pin|AGX_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, USBL_TX_Pin|USBL_RX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, VIT6_TX_Pin|VIT6_RX_Pin);
