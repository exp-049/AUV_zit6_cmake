...
class DepthUartRxSink {
public:
  virtual ~DepthUartRxSink() = default;
  virtual void onRxByte(uint8_t byte) = 0;
};
 ...
 */
class UART_DepthBackend : public DepthBackend, public DepthUartRxSink {
public:
