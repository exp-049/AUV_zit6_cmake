...
SystemConfig sys_config = {
    .chassis = {
        ...
        .x = { 8.0, 0.0, 8.0, 0.3, 0.5, 1.0, 0.02, 0.01, 0.03, 0.8, 0.8, 0.4, 0.013, 2.0 },
        .y = { 8.0, 0.0, 8.0, 0.3, 0.4, 1.0, 0.02, 0.01, 0.03, 0.9, 0.6, 0.3, 0.013, 2.5 },
        .z = { 50.0, 0.1, 0.2, 0.2, 0.5, 10.0, 0.1, 0.0, 0.2, 0.8, 0.5, 0.3, 0.016, 5.0 },
        .yaw = { 8.0, 0.0, 0.1, 0.5, 1.5, 1.2, 0.001, 0.001, 0.01, 1.0, 1.0, 0.8, 0.0003, 0.0005 }
    },
