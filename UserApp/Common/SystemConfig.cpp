...
SystemConfig sys_config = {
    .chassis = {
        ...
        .x = { 8, 0.0, 8, 0.3, 0.9, 1, 0.02, 0.01, 0.03, 0.8, 0.8, 0.4, 0.013, 0.015 },
        .y = { 1.6, 0.0, 0.1, 0.3, 0.6, 0.7, 0.02, 0.01, 0.03, 0.1, 0.6, 0.3, 0.013, 0.025 },
        .z = { 50, 0.1, 0.2, 0.2, 0.5, 10, 0.1, 0, 0.2, 0.8, 0.5, 0.3, 0.016, 0.04 },
        .yaw = { 8, 0.0, 0.1, 0.5, 1.5, 1.2, 0.001, 0.001, 0.01, 1, 1.0, 0.8, 0.0003, 0.0005 }
    },
    .ins = { 45.7749, 126.6765 },
    .soft_watchdog = { 3000, true, false, false },
    .sensors = { ZDataSource::USE_INS_INTEGRATED_Z },
...
const ParamMeta SYSTEM_PARAMS[] = {
    ...
    {"chassis.x.pos_kp", &sys_config.chassis.x.pos_kp, ParamType::UINT32},
    {"chassis.x.pos_ki", &sys_config.chassis.x.pos_ki, ParamType::FLOAT},
    {"chassis.x.pos_kd", &sys_config.chassis.x.pos_kd, ParamType::UINT32},
    ...
    {"chassis.x.vel_kp", &sys_config.chassis.x.vel_kp, ParamType::UINT32},
    ...
    {"chassis.z.pos_kp", &sys_config.chassis.z.pos_kp, ParamType::UINT32},
    ...
    {"chassis.z.vel_kp", &sys_config.chassis.z.vel_kp, ParamType::UINT32},
    {"chassis.z.vel_ki", &sys_config.chassis.z.vel_ki, ParamType::FLOAT},
    {"chassis.z.vel_kd", &sys_config.chassis.z.vel_kd, ParamType::UINT32},
    ...
    {"chassis.yaw.pos_kp", &sys_config.chassis.yaw.pos_kp, ParamType::UINT32},
    ...
    {"chassis.yaw.vel_output_limit", &sys_config.chassis.yaw.vel_output_limit, ParamType::UINT32},
